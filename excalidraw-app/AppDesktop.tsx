...
const initializeDesktopScene = async (): Promise<{
...
const ExcalidrawDesktopWrapper = () => {
  ...
  const loadImages = useCallback(
    (data: ResolutionType<typeof initializeDesktopScene>, isInitialLoad = false) => {
  ...
  useEffect(() => {
    ...
    initializeDesktopScene().then((data) => {
...
export default ExcalidrawDesktopApp;
