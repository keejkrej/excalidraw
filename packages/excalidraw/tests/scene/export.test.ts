...
import { applyDarkModeFilter, FONT_FAMILY, FRAME_STYLE } from "@excalidraw/common";
...
describe("exportToSvg", () => {
  ...
  it("with dark mode", async () => {
    ...
    textElements.forEach((textEl) => {
      ...
      expect(textEl.getAttribute("fill")).toBe(applyDarkModeFilter(textFixture.strokeColor));
    });
  });
