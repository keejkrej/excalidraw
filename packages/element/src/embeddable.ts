import { FONT_FAMILY, VERTICAL_ALIGN, escapeDoubleQuotes, getFontString } from "@excalidraw/common";
...
const parseGoogleDriveVideoLink = (
  ...
  try {
    ...
    return {
      fileId,
      resourceKey: resourceKey && /^[a-zA-Z0-9_-]+$/.test(resourceKey) ? resourceKey : undefined,
