...
const adjustCropPosition = (crop: ImageCrop, scale: ExcalidrawImageElement["scale"]) => {
  let cropX = crop.x;
  let cropY = crop.y;
...
export const getFlipAdjustedCropPosition = (element: ExcalidrawImageElement, natural = false) => {
